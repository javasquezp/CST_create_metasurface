classdef CST_MicrowaveStudio < handle
    ...
    methods
        ...
        function addNormalMaterial(obj,name,Eps,Mue,tand,C,varargin)
        ...
        function addPlaneWave(obj)
           VBA =  sprintf(['With PlaneWave\n',...
                '.Reset\n',...
                '.Normal "0", "0", "-1"\n',...
                '.EVector "-1", "0", "0" \n',...
                '.Polarization "Linear" \n',...
            ...
            obj.update(['define plane wave properties: '],VBA);

        end
%   function Solver(obj,X,Y,Z,R,impedance)         
...
%      'End With']);
%     obj.update(['define time domain solver parameters: '],VBA);
%   end
...
'StopVersionStringOverrideMode \n']);
    obj.update(['define time domain solver acceleration: '],VBA);
  end 
        ...
        function rotateObject(obj,varargin)
            ...
            p.addParameter('repetitions',1);
            p.addParameter('unite',false);

            p.parse(varargin{:});
            
            copy = p.Results.copy;
            repetitions = p.Results.repetitions;
            unite=p.Results.unite;
        ...
        function [Out] = getMeshInfo(obj,type)
            if nargin == 1
                type = 'all';
            end
